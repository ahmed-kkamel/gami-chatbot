    ...
    return (
        <div className="flex-1 p-3 overflow-auto bg-[#EFF1F1] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300" ref={chatContainerRef}>
            {showAssistanceForm ? (
                ...
                <>
                    <div className="my-2">
                        <p className={`text-[#3C3C3C] text-xs px-5 ${isExpanded && !isMobile ? "text-base" : "text-xs"}`}>I&apos;m here to help you with all your policy-related questions.</p>
                        <p className="font-bold text-xs text-[#3C3C3C]">How can I help you today?</p>
                    </div>
