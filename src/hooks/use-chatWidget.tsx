...
export function useChatWidget() {
    ...
    const [textDirection, setTextDirection] = useState<"en-to-ar" | "ar-to-en" | null>(null);
    ...
    const sendMessage = useCallback(async (message?: string) => {
        ...
        let storedSessionId: string | null = sessionStorage.getItem("chatSessionId");
        ...
        try {
            ...
            const errorMessage: string = (error as { response?: { data?: { detail?: string } } })?.response?.data?.detail ?? "An error occurred";
            setMessages((prev) => [
                ...prev,
